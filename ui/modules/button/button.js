...
export default class cButton extends cPrimitiveButton {
  ...
  get computedButtonClass() {
    return classSet('lwc-button')
      .add({
        'lwc-button_neutral': this.normalizedVariant === 'neutral',
        'lwc-button_brand': this.normalizedVariant === 'brand',
        'lwc-button_outline-brand': this.normalizedVariant === 'brand-outline',
        'lwc-button_destructive': this.normalizedVariant === 'destructive',
        'lwc-button_text-destructive':
          this.normalizedVariant === 'destructive-text',
        'lwc-button_inverse': this.normalizedVariant === 'inverse',
        'lwc-button_success': this.normalizedVariant === 'success',
        'lwc-button_first': this._order === 'first',
        'lwc-button_middle': this._order === 'middle',
        'lwc-button_last': this._order === 'last'
      })
      .toString()
  }
